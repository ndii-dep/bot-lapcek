...
// ============================================
const piketSchedule = {
    kamis: ['Putra', 'Qorry', 'Nur', 'Achmad', 'Rahmat', 'Ifuazan'],
    jumat: ['Muzaki', 'Rayyaa', 'Andi', 'Aimee', 'Syahmi', 'Mozza', 'Asyraf'],
    senin: ['Rivanno', 'Anum', 'Raffa', 'Mario', 'Zaskia', 'Kafkah', 'Nazwa'],
    selasa: ['Rifqi', 'Fakhri', 'Saifi', 'Azkia', 'Rayzan', 'Humairo', 'Rivanni'],
    rabu: ['Wahyu', 'Umar', 'Silvi', 'Ashra', 'Messi', 'Wina', 'Fahri'],
};
